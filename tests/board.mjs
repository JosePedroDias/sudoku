...
'-----'-----'-----'`
  ...
  b.setState81(
    '500420800403070010010060000020734006000205000100698040000080020060040905008057001'
  );
  tap.equal(
    b.getStateAscii(),
    `.-----.-----.-----.
...
tap.test('checkDone', (t) => {
  ...
  b.setState81(
    '576421839483579612912863574829734156634215798157698243395186427761342985248957361'
  );
  tap.ok(b.checkDone());
